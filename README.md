...
Bash
git clone https://github.com/yourusername/ai-accountant-analyzer.git
cd ai-accountant-analyzer
2. Install Dependencies
Bash
pip install streamlit groq pandas plotly python-dotenv
...
⚠️ Disclaimer: This application is intended for informational purposes only and does not constitute official financial advice.